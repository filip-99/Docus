...
namespace CandidateApp.Controllers
{
    ...
    public class CandidatesController : ControllerBase
    {
        ...
        {
            var candidate = _candidatesService.GetCandidateWithFormById(id);
            return Ok(candidate);
        }
        ...
        [HttpPost("add-candidate-with-forms-actions")]
        ...
        {
            _candidatesService.AddCandidateWithForms(candidate);
